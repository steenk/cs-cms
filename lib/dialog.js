...
const widgetType = {
    ...
    'parameter-boolean': function (widget, key) {
        return ['cs-oc-widget-parameter-boolean', {
            parameter: "controller.getParameter('" + key + "')"
        }];
    },
    ...
    relation: function (widget, key) {
        let attr = {
            ...
            multiple: !!widget.parameters.multiple
        }
    ...
    'sorted-relation': function (widget, key) {
        ...
        if (widget.parameters[key].assettype) {
            attr['allowed-for'] = "{ assettype: '" + widget.parameters[key].assettype + "' }"
        }
    ...
    'parameter-select': function (widget, key) {
        ...
        if (widget.parameters.feature) {
            attr.feature = widget.parameters.feature;
        }
